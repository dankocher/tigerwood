...
const Icons = props => (<div className="-s01-icons">
    <div className="qual-icon slideInDown delay2">
        ...
        <div className="-i-t-icon">
            {formatText(t.text_icon_1)}
        </div>
    </div>
    <div className="qual-icon slideInDown delay3">
        <Icon02 {...props}/>
        <div className="-i-t-icon">
            {formatText(t.text_icon_2)}
        </div>
    </div>
    <div className="qual-icon slideInDown delay4">
        <Icon03 {...props}/>
        <div className="-i-t-icon">
            {formatText(t.text_icon_3)}
        </div>
    </div>
</div>)

const arrow = <div className={"arrow"}><svg width="86" height="8" viewBox="0 0 86 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//slideInDown delay4
const Button = props =>( <div className="-s01-button">
    <div className="b-top-text">{t.button_text_1}</div>
    <div className="b-bottom-text">{t.button_text_2}{arrow}</div>
</div>)

const Box = props => ( <div className="-s01-box slideInDown delay5">
    <div className="box-top">
        ...
        <div className="b-t-text">{formatText(t.block_text_1)}</div>
    </div>
    <div className="box-bottom">
        ...
        <div className="b-t-2">
            <div className="b-t-text-2">{t.block_text_2}</div>
            <div className="b-t-text-2a">{t.block_text_2a}</div>
        </div>
    </div>
</div>)
